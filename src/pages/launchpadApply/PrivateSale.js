          ...
          <div className="container px-3">
            <div className="intro">
              <div className="intro-content text-center">
                <span className="intro-text">Create Private Sale</span>
              </div>
            </div>
            <div className="signup-step-container my-5">
              ...
              <div className="mt-4 text-white">
                Investing in crypto is risky, only invest what you can afford to lose. Do your own research (DYOR). Not financial advice (NFA).
              </div>
            </div>
          </div>
        </section>
