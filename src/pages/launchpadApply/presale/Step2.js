  ...
  const checkValidation = (input, inputValue) => {
    ...
    switch (input) {
      ...
      case "softcap":
        ...
        // ) {
        //   terror += 1;
        //   message = "Softcap must be greater than or equal 25% of Hardcap";
        // } else if (
        //   parseFloat(value.hardcap) > 0 &&
        ...
        //   message = "Softcap must be less than or equal Hardcap";
          ...
          // message = "";
          value.hardcap = (inputValue / 25) * 100;
          value.hardcap = parseFloat(value.hardcap.toFixed(1));
        }
        break;
      ...
      case "endtime":
        ...
        break;
      case "llockup":
          const inputValueInHours = parseFloat(inputValue);
        
          if (isNaN(inputValueInHours) || inputValueInHours <= 0) {
            console.log("terror 21");
            terror += 1;
  ...
  return (
    ...
    >
      <h4 className="text-center">
        Fill in your launchpad details.
      </h4>
      <div className="row">
        ...
        <div className="col-md-6 mt-4 mb-0">
          <div className="form-group">
            <label>
              ...
              <small className="text-danger">{`Softcap must be >= 25% of Hardcap!`}</small>
              )
            </label>
            <input
              className="form-control"
        ...
        <div className="col-md-12">
          <label className="mt-4 text-white">
            Select the start time & end time of your presale
          </label>
        </div>
        <div className="col-md-6 mt-4 mb-0">
          <div className="form-group">
        ...
        <div className="form-group">
  <label>
    Liquidity lockup (hours)<span className="text-danger">*</span>
  </label>
  <input
    className="form-control"
    value={value.llockup}
