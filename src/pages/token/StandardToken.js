  ...
  const handleCreateToken = async (e) => {
    ...
    if (check) {
      try {
        ...
        // let tokenContractGem = new window.web3.eth.Contract(gempadJson.abi);
        ...
        //     createFee.toString(),
        //   ], bytecode: tokenByte["StandardToken"], value: createFee.toString()
        // });
        // return;
