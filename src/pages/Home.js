      ...
      <section id="home" className="project-area pt-0">
        <div className="container p-5">
          <div className="text-center mt-5">
            ...
            <p>
            Innovating the BASE ecosystem through the Defi Launch Defi Launchpad
            </p>
          </div>
          <div className="text-center mt-5">
            <Link to="/presale">
          ...
          <div className="row my-5">
            ...
            <div className="col-12 col-md-3">
              <div className="card d-flex flex-column justify-content-center align-items-center text-center my-2 pt-4 pb-4">
                ...
                <p className="">
                  Adding logo, social links, description, listing on Defi Launch.
                </p>
              </div>
            </div>
            <div className="col-12 col-md-3">
            ...
            <div className="col-12 col-md-3">
              <div className="card d-flex flex-column justify-content-center align-items-center text-center my-2 pt-4 pb-4">
                ...
                <p>Promote your launchpad to thousands of buyers on Defi Launch.</p>
              </div>
            </div>
            <div className="col-12 col-md-3">
              <div className="card d-flex flex-column justify-content-center align-items-center text-center my-2 pt-4 pb-4">
                ...
                <p>
                  Lock your liquidity to Defi LaunchSwap, PancakeSwap after presale.
                </p>
              </div>
            </div>
          </div>
