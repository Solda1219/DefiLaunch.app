...
import heartbeatImage from '../images/heartbeat.png';
...
export const Connect = function () {
    ...
    if (error instanceof UnsupportedChainIdError) {
      return (
        ...
        >
            ...
            <img src={heartbeatImage} alt="Wrong Network" height="17px" width="17px" className="mx-2" />
          Wrong Network
        </span>
      );
    }
  ...
  const switchNetwork = (networkid) => {
    ...
    try {
      ...
      console.log("chainId in swith", chainId);
    } catch (e) {
      console.error(e);
    }
  };
    ...
    <React.Fragment>
      ...
      {/**   {active && (
            ...
            <button
              type="button"
              className="btn"
              disabled={true} // This will make the "Points" button unclickable
              onClick={() => {}}
              title="Points Coming Soon" // Add the title attribute for the tooltip
            >
              <img
                src={require("../../src/images/trophy.png").default}
                alt="trophy-icon"
                height="10px"
                width="10px"
                className="mx-2"
